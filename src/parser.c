...
static const TSMapSlice ts_supertype_map_slices[] = {
  [sym__class_linetype] = {.index = 0, .length = 2},
  [sym__class_reltype] = {.index = 2, .length = 4},
  [sym__class_stmt] = {.index = 6, .length = 4},
  [sym__direction] = {.index = 10, .length = 4},
  [sym__er_attribute_key_type] = {.index = 14, .length = 2},
  [sym__er_cardinarity] = {.index = 16, .length = 4},
  [sym__er_reltype] = {.index = 20, .length = 2},
  [sym__er_stmt] = {.index = 22, .length = 3},
  [sym__flow_link] = {.index = 25, .length = 3},
  [sym__flow_stmt] = {.index = 28, .length = 3},
  [sym__flow_vertex_kind] = {.index = 31, .length = 15},
  [sym__flowchart_direction] = {.index = 46, .length = 4},
  [sym__gantt_stmt] = {.index = 50, .length = 10},
  [sym__pie_stmt] = {.index = 60, .length = 2},
  [sym__sequence_stmt] = {.index = 62, .length = 17},
  [sym__state_annotation] = {.index = 79, .length = 3},
  [sym__state_stmt] = {.index = 82, .length = 8},
};
